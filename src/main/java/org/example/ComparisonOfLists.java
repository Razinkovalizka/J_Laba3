 ...
 */
public final class ComparisonOfLists {
     ...
     */
    public ComparisonOfLists(final int MAX_SIZE, final int OPERATIONS) {
    ...
    /**
     * Метод для сбора данных о производительности и построения таблицы
     */
